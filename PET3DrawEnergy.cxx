...
void ShowVersion(int a_returnCode){
    cout<<endl;
    cout<<"   PET3DrawEnergy version  1.0  "<<endl;
    ...
    cout<<"     :Only draw energy;                                        2019/01/15 "<<endl;
    cout<<endl;
    exit(a_returnCode);
}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    TH1S *Energy[NPixels];
    TH1S *EnergySub[NSubMod];
    for(int i=0;i<NPixels;i++){
        sprintf(buf,"Energy_Ax%d_Tx%d",i%NZX,i/NZX);
        Energy[i] =hist1dS(buf,Nbin,0,Nbin,"Energy (ch)","Entries");
        if(i<NSubMod){
            sprintf(buf,"EnergySub_Ax%d_Tx%d",i%NSubAx,i/NSubAx);
            EnergySub[i] =hist1dS(buf,Nbin,0,Nbin,"Energy (ch)","Entries");
        }
    }
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////                                              string for pdf/png                                              ////
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    cout<<"---------------- Start path/pdf/png definations---------------"<<endl;
      ...
      string EnergySubModSpectrumName = path_to_output_file+"/"+"Energy_SubModules_Spectrum";
      ...
      string EnergySubModSpectrumPdf1=EnergySubModSpectrumName+".pdf[";
      string EnergySubModSpectrumPdf2=EnergySubModSpectrumName+".pdf";
      string EnergySubModSpectrumPdf3=EnergySubModSpectrumName+".pdf]";
      ...
      //Generate root file;
      string root_hist_file = path_to_output_file +"/" +"Energy_Histogram.root";
                   ...
                   cout<<"-----------------------------------faker flag" <<endl;
                    ...
                    for(int i=0; i<Nbyte; i++){
                        ...
                        if(Save_Hist){
                            ...
                            EnergySub[index1]->Fill(Adc1);
                            EnergySub[index2]->Fill(Adc2);
                        }
                    ...
                    if(( (dataeff[i]>>48) & 0xFFFF) == 0x8000){
    	                ...
    	                if(Save_Hist){
                            if(Ax<NZX&&Tx<NCX){ 
                                ...
                                index = (Tx/TxInSub)*NSubAx+Ax/AxInSub;
                                EnergySub[index]->Fill(Adc);
    ...
    TVirtualPad *tv[16];
    if(Save_Pdf){
     c1->Print(EnergyPixelsSpectrumPdf1.c_str());
     c1->Divide(4,4);
         ...
         for(int i=0;i<NPixels;i++){
              ...
              if(i%16==15){
                 c1->Print(EnergyPixelsSpectrumPdf2.c_str());
              }
         }
     c1->Print(EnergyPixelsSpectrumPdf3.c_str());
     }
    

    TVirtualPad *tvp[6];
    if(Save_Pdf){
     c2->Print(EnergySubModSpectrumPdf1.c_str());
     c2->Divide(3,2);
         ...
         for(int i=0;i<NSubMod;i++){
              ...
              if(i%6==5){
                 c2 ->Print(EnergySubModSpectrumPdf2.c_str());
              }
         }
     c2->Print(EnergySubModSpectrumPdf3.c_str());
     }
