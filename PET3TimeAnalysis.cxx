...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    for(int i=0;i<NPixels;i++){
        ...
        if(i<NSubMod){
            sprintf(buf,"Time_SubMod_Ax%d_Tx%d",i%AxInSub,i/AxInSub);
                   ...
                   cout<<"-----------------------------------faker flag" <<endl;
                    ...
                    for(int i=0; i<Nbyte; i++){
                        ...
                        if(Save_Hist){
                            ...
                            TimeSub[index1]->Fill(-tdiff);
                            TimeSub[index2]->Fill( tdiff);
                        }
    ...
    if(Save_Pdf){
     ...
     c2->Divide(4,3);
         ...
         for(int i=0;i<NSubMod;i++){
              ...
              tvp[i%12] =c2->cd(i%12+1);
              TimeSub[i]->GetXaxis()->SetRangeUser(-200,200);
              TimeSub[i]->Draw();
              
              if(i<NSubMod-1 && i%12==11){
