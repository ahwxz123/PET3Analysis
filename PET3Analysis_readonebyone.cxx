...
void ShowVersion(int a_returnCode){
    cout<<endl;
    cout<<"   PET3Analysis version  0.1  "<<endl;
    cout<<endl;
    exit(a_returnCode);
}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    for(int MM=0; MM<size; MM++){
        ...
        if(data_type==single_data_type){
            ...
            //while(fin.good()){
                fin.read((char*)(&data),4*2);
                datacon[0]   = PET3RawdataConvert(data[1]);
                datacon[1]   = PET3RawdataConvert(data[0]);
                datatest  = ((datacon[1] )<<32) | (datacon[0] &0xFFFFFFFF);
                if(( (datatest>>48) & 0xFFFF) == 0x8000){
                    timezone = datatest&0xFFFFFFFF ;
                }
                else if(( (datatest>>48) & 0xFFFF) == 0){
                    multhit      = (datatest>>47) & 0x1;
                    ovflow       = (datatest>>46) & 0x1;
                    coarse       = (datatest>>34) & 0xFFF;
                    fine         = (datatest>>26) & 0x1F;
                    Adc          = (datatest>>16) & 0x3FF;
                    Tx           = (datatest>>6)  & 0x3FF;
                    Ax           =  datatest      & 0x3F;
