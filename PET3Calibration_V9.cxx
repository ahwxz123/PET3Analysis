...
const unsigned int FakerFlagThreshold=64000000;
...
//    cout<<"     :Cocincidence flag 0xFFFFFFFC; 16vevents in one flag;       2019/01/10 "<<endl;
    ...
    cout<<"     : -tmean[index1]/2.+tmean[index2]/2,;                       2019/01/21 "<<endl;
    cout<<"     : Save the lut     -tmean[.]/2.;                            2019/01/21 "<<endl;
    cout<<endl;
    exit(a_returnCode);
}
...
void ShowHelp(int a_returnCode){
    ...
    cout<<"         -iterRoot  XXX            : save iteration root file or not. XXX: y/yes/Yes/YES/Y/n/no/No/NO/N. (default negetive)"<<endl;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      memset(tmean,0,sizeof(double )*NPixels);
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////                                              histgream define                                               ////
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     ////////////// string name for saving pdf/png;
      ...
      string Time2DCalibName         = path_to_output_file+"/"+"Time_versusAngleRing_Calib";
      ...
      string Time2DCalibPng          = Time2DCalibName+".png";
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    for(int i=0;i<NPixels;i++){
        if(TimeCalibOn){
            ...
            //Time[i]->Fit(fitfun[i],"","",coeff1-5*coeff2,coeff1+5*coeff2);
            //coeff1 = fitfun[i]->GetParameter(1);
            //coeff2 = fitfun[i]->GetParameter(2);
            //Time[i]->GetXaxis()->SetRangeUser(coeff1-5*coeff2,coeff1+5*coeff2);
            //Time[i]->Fit(fitfun[i],"","",coeff1-coeff2,coeff1+coeff2);
            //tmean[i] =tmean[i]+ fitfun[i]->GetParameter(1);
        }
    }
    
    if(Save_IterRoot){
       string saveraw                = path_to_output_file+"/"+"Calibration_cor1times_histogram_iter0"+".root";
       TFile *sfile = new TFile(saveraw.c_str(), "recreate");
       sfile->cd();
       for(int i=0;i<NPixels;i++){
           Time[i] ->Write();
       }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if(TimeCalibOn){
	    ...
	    //cout<<" -----   Time calibration Iteration -->"<<NN+1<<" begins ....."<<endl;
            ...
            TimeRes_cor ->Reset();
            TimevsAngle_cor ->Reset();
            TimevsRing_cor->Reset();
            for(int i=0; i<NPixels; i++){
		        Time[i]->Reset();
            } 
            for(int MM=0; MM<size; MM++){
                    ...
                    while(fin.good()  ){
                        ...
                        if(CoincidenceFlag!=datatest){
                            ...
                            for(int i=0; i<Nbyte; i++){
                                ...
                                tdiff_cor1 = static_cast<double>(-tdiff) -tmean[index1]/2. + tmean[index2]/2. ;
                                tdiff_cor2 = static_cast<double>( tdiff) -tmean[index2]/2. + tmean[index1]/2. ;
    ...
    if(Save_IterRoot){ 
       string savetest                = path_to_output_file+"/"+"Calibration_cor1times_histogram_iter"+to_string(NN+1)+".root";
    ...
    cout<<"------ time Calibration iteration "<< NN+1<<" has been done ..."<<endl;
     ...
     TimeRes ->Fit(fitf1,"QNC","",-20,20);
     TimeRes_cor ->Fit(fitf2,"QNC","",-20,20);
     fitf2 ->SetLineColor(6);  
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////                                              Save LUT                                                  ////
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if(Save_Png){
        ...
        if(TimeCalibOn){
            ...
            ttxt1.SetText(0.27,0.30,buf);
            ttxt2.SetText(0.27,0.15,buf2);
            ...
            c2->Divide(1,2);
            c2->cd(1);
            TimevsAngle_cor->Draw("colz");
            c2->cd(2);
            TimevsRing_cor ->Draw("colz");
            c2->Print(Time2DCalibPng.c_str());
        }
    }
